...
public class PLPRuntimeImageOps {
	...
	public static final String addSig = "(" + PLPRuntimeImageIO.BufferedImageDesc + PLPRuntimeImageIO.BufferedImageDesc
			+ ")" + PLPRuntimeImageIO.BufferedImageDesc;
	...
	public static final String subSig = "(" + PLPRuntimeImageIO.BufferedImageDesc + PLPRuntimeImageIO.BufferedImageDesc
			+ ")" + PLPRuntimeImageIO.BufferedImageDesc;
